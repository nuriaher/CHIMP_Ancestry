...
nohup python ${data_path}/CHIMP_Ancestry/chimp_ancestry.py -input ${data_path}/input_BIV_V.txt -out_path ${data_path} --pca_plot > ${data_path}/CA_BIV_V.log &
nohup python ${data_path}/CHIMP_Ancestry/chimp_ancestry.py -input ${data_path}/input_BVI.txt -out_path ${data_path} --pca_plot > ${data_path}/CA_BVI.log &

	# two samples together BI_II-BIII
nohup python ${data_path}/CHIMP_Ancestry/chimp_ancestry.py -input ${data_path}/input_BI_II-BIII.txt -out_path ${data_path} --pca_plot > ${data_path}/CA_BI_II-BIII.log &
